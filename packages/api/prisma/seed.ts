...
async function main() {
  ...
  const usersData = [
    { name: 'Administrador', email: 'admin@sdesk.dev', role: 'ADMIN' },
    { name: 'Gerente de TI', email: 'manager@sdesk.dev', role: 'MANAGER' },
    { name: 'Ana Souza', email: 'ana@sdesk.dev', role: 'AGENT', solverGroupId: groupN1 },
    { name: 'Bruno Lima', email: 'bruno@sdesk.dev', role: 'AGENT', solverGroupId: groupN1 },
    { name: 'Carla Dias', email: 'carla@sdesk.dev', role: 'AGENT', solverGroupId: groupN2 },
    { name: 'Gabriel Prado', email: 'gabriel@sdesk.dev', role: 'AGENT', solverGroupId: groupN3 },
    { name: 'Daniel Costa', email: 'daniel@sdesk.dev', role: 'AGENT', solverGroupId: groupInfra },
    { name: 'Elena Rocha', email: 'elena@sdesk.dev', role: 'AGENT', solverGroupId: groupDevops },
    { name: 'Fábio Nunes', email: 'fabio@sdesk.dev', role: 'AGENT', solverGroupId: groupRedes },
    { name: 'Gustavo Pereira', email: 'gustavo@sdesk.dev', role: 'USER' },
    { name: 'Helena Martins', email: 'helena@sdesk.dev', role: 'USER' },
    { name: 'Ivan Alves', email: 'ivan@sdesk.dev', role: 'USER' },
  ] as const;
  ...
  const tickets: Prisma.TicketUncheckedCreateInput[] = [
    ...
    { ticketNumber: 'SD-2026-000008', requesterId: gustavoId, beneficiaryId: gustavoId, title: 'Instalação do novo CRM', description: 'Instalar cliente CRM nas estações do comercial', type: 'SERVICE_REQUEST', priority: 'HIGH', impact: 'MEDIUM', urgency: 'HIGH', status: 'IN_PROGRESS', companyId: acme.id, solverGroupId: groupDevops, assigneeId: elenaId, slaResponseAt: hoursFromNow(24), slaResolveAt: hoursFromNow(48) },
    ...
    { ticketNumber: 'SD-2026-000010', requesterId: helenaId, beneficiaryId: helenaId, title: 'Criar e-mail corporativo', description: 'Novo colaborador entrará na próxima semana', type: 'SERVICE_REQUEST', priority: 'MEDIUM', impact: 'LOW', urgency: 'MEDIUM', status: 'OPEN', companyId: acme.id, solverGroupId: groupN1, slaResponseAt: hoursFromNow(48), slaResolveAt: hoursFromNow(96) },
    { ticketNumber: 'SD-2026-000011', requesterId: gustavoId, beneficiaryId: gustavoId, title: 'VPN não conecta (remoto)', description: 'Cliente VPN falha ao estabelecer túnel', type: 'INCIDENT', priority: 'HIGH', impact: 'MEDIUM', urgency: 'HIGH', status: 'OPEN', companyId: acme.id, solverGroupId: groupRedes, assigneeId: fabioId, slaResponseAt: hoursFromNow(2), slaResolveAt: hoursFromNow(24) },
  ...
  console.log(`  RoutingRules: 4 | SLA: ${sla.count} | KB: 3 | ApprovalFlows: 2`);
