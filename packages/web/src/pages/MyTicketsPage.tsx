...
import { Building2, FolderClock, Search, Tag } from 'lucide-react'
    ...
    <div className="flex flex-col gap-5">
      <div>
        ...
        <p className="text-sm text-bodystroke">
          {isTeam
            ? t('tickets.myTicketsSubtitleAgent', { count: pagination?.totalItems ?? 0 })
            : t('tickets.myTicketsSubtitleUser', { count: pagination?.totalItems ?? 0 })}
        </p>
      </div>
      ...
      <Card bodyClassName="p-0">
        <div className="grid grid-cols-1 gap-3 border-b border-stroke p-4 dark:border-strobedark sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="border-t border-stroke p-4 dark:border-strobedark">
          {isLoading ? (
