  ...
  return (
    <textarea
      className={cn(
        ...
        'placeholder:text-bodystroke focus:border-primary focus:ring-2 focus:ring-primary/20',
        'dark:border-strokedark dark:bg-boxdark dark:text-white dark:placeholder:text-bodydark',
